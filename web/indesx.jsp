...
<div class="head">
  <img src="images/logo.png"  style="width: 120px;height: 60px;margin-left: 10%;"/>
  <input type="text" style="border: 0px solid yellow;border-radius:4px;width: 700px;height:40px;padding-left: 12px;position: absolute;left: 24%;top:13px;"/>
  <button class="button button-glow button-border button-rounded button-primary" style="position: absolute;left: 66%;top: 12px;height: 44px;width: 60px;border: opx solid aquamarine;border-radius: 4px;border-left: 1px solid #fff;">Go</button>
  <a href="login.jsp" style="position: absolute;left: 72%;top: 12px;">登录</a>
</div>
<hr />
<div class="bigbig">
