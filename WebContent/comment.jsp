...
<title>用户动态</title>
        ...
        <link rel="stylesheet" href="css/hehe.css" type="text/css">     
    ...
    <div class="bigDiv"> 
        <div class="div_left">
           <div class="div_left_1">
               <div class="div_left_1_title"><p>你是魔鬼吗？</p></div>
               <div class="div_left_1_tu"><img src="img/login1.jpg" style="width:250px;height:200px;"/></div>
               <div class="div_left_1_jishao"></div>
               <div class="div_left_1_state"><p id="comment">评论</p></div>
               
               <div class="comment" id="comment1" style="display:none">
                     <!--
