...
<div class="daohang">
    <ul id="test_ul">
        ...
        <li><a href="User_ckupload?user_id=${user.id}" target="text">我的作品</a></li>
    ...
    <iframe id="iframe" onload="iframe()"  frameborder="0" scrolling="yes" class="iframe_c" src="Personal_center.jsp" name="text">
