...
<head>
    ...
    $(function () {
    	$("#iframeHeight").height(500);
    	var f = $("#iframeHeight").height();//500
    	var ff = $(this).height();
    	 var fff = $("iframe").contents().find("body").height();
    	 $("a[target='text_nav']").click(function() {
    		 var ffff =  $("iframe").contents().find("body").height();
    	 /*    alert(ff);
    	    alert(fff);
    	    alert(ffff); */
    	    	if(fff>=f){
    	    		$("#iframeHeight").height(f);
    	    		
    	    	}else{
    	    		$("#iframeHeight").height(ff); //
    	    	}
                ...
                <div class="header_menu">
                    <ul id="menu">
                        ...
                        <div class="info">
                            ...
                            <hr>
                            <div>
                                <i class="fa fa-leanpub" style="font-size:18px;color:#1E98F4;margin-right: 8px;"></i><a href="my_collection.jsp" target="text_nav">我的作品</a>
                            </div>
                            <hr>
                            <div>
                                <i class="fa fa-upload" style="font-size:18px;color:#1E98F4;margin-right: 8px;"></i><a href="upload_picture.jsp" target="text_nav">上传图片</a>
                            </div>
                            <hr>
                            <div>
...
<div style="width: 100%;height: 200px;border: 0px solid red;background-image: url(images/bg.jpg);">
...
<div id="iframeHeight" style="width: 100%;">
    <iframe id="iframe" frameborder="0" scrolling="no"   src="Personal_center.jsp"  name="text_nav" style="width: 100%;height:100%">
                    ...
                    <div class="span4 col-xm-6 col-xs-12 text_align">
                        <div class="footer_list">
                            <div class="footer_cotact">
                                ...
                                <ul>
                                    <li class="">
                                        <img style="width: 40%;height: 40%;" src="img/guangyingqq.jpg" alt=""/>
                                    </li>
                                </ul>
                            </div>
                        </div>
