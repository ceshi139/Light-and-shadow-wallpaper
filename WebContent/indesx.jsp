		 ...
		 <div class="platform_advantage" style="background:#253242;">
                    <div class="bigbig">
                       ...
                       <input type="hidden" id="user_id" value="${user.id}"/>
                                ...
                                <div class="a">
                                    ...
                                    <div class="b">
                                        ...
                                        <div class="my_like_div2"  title="下载此图片">
                                   		...
                                   		<img style="position:relative;top: 90%;left: 10px; width: 60px;height: 60px;border-radius: 50%;" src="http://q.qlogo.cn/headimg_dl?bs=qq&dst_uin=<s:property value="user.email" />&src_uin=qq.zy7.com&fid=blog&spec=640" />
                                    </div> 
                                </div>   
                            </s:iterator>
                        </div>
                            ...
                            <s:iterator value="#session.pc2">
                                <div class="a">
                                    ...
                                    <div class="b">
                                        ...
                                        <div class="my_like_div3" name="<s:property value="user.id"/>" title="关注">
                                            <img title="添加关注" src="img/guanzhu.jpg" class="guanzhu">
                        ...
                        <div class="big">
                            <s:iterator value="#session.pc3" status="status">
                                ...
                                <div class="a">
                                    ...
                                    <div class="b">
                                        ...
                                        <div class="my_like_div3" name="<s:property value="user.id"/>" title="关注">
                                          ...
                                          <span><s:property value="#status.user.email" />12</span>
