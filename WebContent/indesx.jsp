...
<body style="background-color: #253242">
		 <div class="platform_advantage" style="background:#253242;">
             ...
             <s:if test="#page.hasmore">
                 <div style="float:left;width:50%;margin:100px 0px 50px 30%;color:#fff;">
                     <b>当前页为第<s:property value="#page.pageNow" />页 共<s:property value="#page.TotalPage"/>页</b>
                     <s:if test="#page.hasFirst">
                         <a href="User_findPicture?type_id=<s:property value="#session.type_id" />&pageNow=1"><input type="button" value="首页" class="fenye"/></a>
                     </s:if>
                     <s:if test="#page.hasPre">
                         <a target="_top" href="User_findPicture?type_id=<s:property value="#session.type_id" />&pageNow=<s:property value="#page.pageNow-1" />"><input type="button" value="上一页" class="fenye"/></a>
                     </s:if>
                     <s:if test="#page.hasNext">
                         <a target="_top" href="User_findPicture?type_id=<s:property value="#session.type_id" />&pageNow=<s:property value="#page.pageNow+1" />"><input type="button" value="下一页" class="fenye"/></a>
                     </s:if>
                     <s:if test="#page.hasLast">
                         <a target="_top" href="User_findPicture?type_id=<s:property value="#session.type_id" />&pageNow=<s:property value="#page.totalPage" />"><input type="button" value="尾页" class="fenye"/></a>
                     </s:if>
                     <input type="text" id="tiao" class="fenye"/><input type="button" value="跳转" class="fenye" id="fenye"/>
                 </div >
             </s:if>
             <s:else>
                 <div id="more" style="width: 240px;margin:0 auto;margin-top: 200px;">
                     ...
                     <img style="width: 240px;" src="images/loadimg-cat.gif" typeid="0" pageSize="<s:property value="#page.pageSize" />" name="<s:property value="#page.pageNow+1" />" />
                 </div>
             </s:else>
