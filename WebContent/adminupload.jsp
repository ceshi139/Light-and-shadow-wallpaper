...
<body>
  <div style="margin-left:10%; margin-top:5%;"> 
    <form action="/admin/upload" method="post" enctype ="multipart/form-data" target="_parent">
                           选择图片：<input type="file" name="file" multiple /><br/><br/> 
          <select name="picture.size">
              <option>全部尺寸</option>
          ...
          <select name="id">
              ...
              <option value="1" >卡通动漫</option>
              <option value="2">动物</option>
              <option value="3">影视</option>
              <option value="4">游戏</option>
              <option value="5">植物</option>
              <option value="6">风景</option>
              <option value="7">明星</option>
              <option value="8">名车</option>
          </select> <br/> <br/>  
