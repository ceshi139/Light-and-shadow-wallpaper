(function($, window, document) {
    ...
    Paging.prototype = {
        ...
        createDom: function() {
            ...
            content = '<button type="button" id="firstPage" class="turnPage first-page"><a href="chaAllType?pageNow='+initPageNo+'">首页</a></button>' +
                '<button class="turnPage" id="prePage"><a href="chaAllType?pageNow='+ initPageNo-1 +'">上一页</a></button>' +
                '<div class="pageWrap" style="width:' + wrapLength + 'px;">' +
                '<ul id="pageSelect" style="transition:all ' + that.options.slideSpeed + 'ms;">' +
                ulDom +
                '</ul></div>' +
                '<a class="turnPage" id="nextPage"><a href="chaAllType?pageNow='+ initPageNo+1 +'">下一页</a></button>' +
