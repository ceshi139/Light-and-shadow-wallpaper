...
public class AdminBizImpl implements AdminBiz {
	...
	//查询全部的图片
	public List chaAllPicture(int pageNow, int pageSize,String imgname,String imgtype,String imgsize,String paixu){
		return adminDao.chaAllPicture(pageNow, pageSize, imgname,imgsize,imgtype,paixu);
	...
	public int findTotalSize(String imgsize,String imgtype,String imgname) {
		...
		return adminDao.findTotalSize(imgsize,imgtype,imgname);
